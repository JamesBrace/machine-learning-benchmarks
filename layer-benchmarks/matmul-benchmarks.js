    ...
    MatmulCPUBenchmark.prototype.run = function (size) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                dl.setBackend('cpu');
                a = dl.randomUniform([size, size], -1, 1);
                b = dl.randomUniform([size, size], -1, 1);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        dl.setBackend('webgl');
                        a = dl.randomNormal([size, size]);
                        b = dl.randomNormal([size, size]);
                        benchmark = function () { return dl.matMul(a, b); };
