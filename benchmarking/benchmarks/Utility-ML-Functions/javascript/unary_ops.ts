...
export class UnaryOpsCPU implements BenchmarkTest {
...
export class UnaryOpsGPU implements BenchmarkTest {
...
export async function run(size, type, params, backend){
    let benchmark: BenchmarkTest = (backend === 'gpu') ? new UnaryOpsGPU() : new UnaryOpsCPU();
